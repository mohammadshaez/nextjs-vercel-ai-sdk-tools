  ...
  <Link href={href}>
    <div className="group relative p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-all duration-300 overflow-hidden cursor-pointer h-full backdrop-blur-sm">
      ...
      <div className="relative z-10">
        <div
          className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-zinc-800 border border-zinc-700 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300`}
        >
          <Icon className="w-6 h-6 text-zinc-100" />
        </div>
        <h3 className="text-xl font-semibold text-zinc-100 mb-3 group-hover:translate-x-1 transition-transform duration-300">
          {title}
        </h3>
      ...
      <div
        className={`absolute -right-8 -bottom-8 w-24 h-24 rounded-full bg-gradient-to-br ${color} opacity-20 blur-2xl group-hover:scale-150 transition-transform duration-700`}
      />
    </div>
  </Link>
);
...
export default function Home() {
  ...
  const features = [
    {
      ...
      description:
        "Build robust AI chat interfaces with real-time streaming and message history management.",
      icon: MessageSquare,
      href: "/ui/chat",
    ...
    },
    {
      ...
      description:
        "Harness the power of text completion for predictive writing and automated content generation.",
      icon: Zap,
      href: "/ui/completion",
    ...
    },
    {
      ...
      description:
        "Generate stunning imagery directly from text prompts using state-of-the-art visual models.",
      icon: ImageIcon,
    ...
    },
    {
      ...
      description:
        "Transform text into natural-sounding speech with ultra-low latency voice synthesis.",
      icon: Mic,
    ...
    },
    {
      ...
      description:
        "Engage with models that understand both text and visual inputs simultaneously.",
      icon: Layers,
    ...
    },
    {
      ...
      description:
        "Implement high-performance streaming for real-time AI responses and dynamic updates.",
      icon: Cpu,
      href: "/ui/stream",
    ...
    },
    {
      ...
      description:
        "Generate validated array schemas for complex data extraction and list management.",
      icon: LayoutGrid,
    ...
    },
    {
      ...
      description:
        "Receive strictly typed JSON objects from LLMs for seamless application integration.",
      icon: Database,
    ...
    },
    {
      ...
      description:
        "Empower your AI with custom tools to perform actions and fetch external data.",
      icon: Wrench,
      href: "/ui/tools",
    ...
    },
    {
      ...
      description:
        "Convert spoken words into accurate text with high-performance audio transcription.",
      icon: FileAudio,
  ...
  return (
    <div className="text-zinc-100 font-sans selection:bg-zinc-100 selection:text-black">
      {/* Background Decor */}
          ...
          <div className="relative w-full max-w-md p-8 rounded-3xl bg-zinc-900 border border-zinc-800 shadow-2xl overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                The features in this ecosystem balance powerful AI logic with
                significant computational costs.
                <span className="text-zinc-100 font-medium">
                  {" "}
                  Please use these tools wisely{" "}
                </span>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-24 sm:py-32 pt-32">
        ...
        <div className="flex flex-col items-center text-center mb-24">
          ...
          <p className="max-w-2xl text-zinc-400 text-lg sm:text-xl leading-relaxed">
            A comprehensive suite of powerful UI features powered by the Vercel
            AI SDK. Build, scale, and deploy futuristic AI experiences with
            ease.
          </p>
        </div>
